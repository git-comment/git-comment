...
=item %ad: author date, RFC822 format

=item %aD: author date, Unix timestamp

=item %cn: committer name

=item %ce: committer email

=item %cd: committer date, RFC822 format

=item %cD: committer date, Unix timestamp
